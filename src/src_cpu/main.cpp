/*
  ...
  Acknowledgement: The FD modules of this code are the CPU adaptation of FD functions
...
mod_t *mod_sp = new mod_t[1];          
wave_t *wave_sp = new wave_t[1];       
geo2d_t *geo2d_sp = new geo2d_t[1];    
job_t *job_sp = new job_t[1];          
